...
class Cart {
    ...
    updateCartUI() {
        ...
        totalElements.forEach(element => {
            element.textContent = window.local_links.formatPrice(this.total);
        });
            ...
            <div class="cart-item border rounded-lg p-4 mb-4" data-product-id="${item.productId}">
                <div class="flex gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600">${window.local_links.formatPrice(item.price)}</p>
                    ...
                    <div class="text-right">
                        <p class="font-semibold">${window.local_links.formatPrice(item.subtotal)}</p>
                    </div>
                </div>
            </div>
        `).join('');
