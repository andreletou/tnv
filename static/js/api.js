...
class CartAPI {
    static async addItem(productId, quantity = 1) {
        try {
            ...
            if (data.success) {
                local_links.updateCartCount();
                local_links.showNotification(data.message, 'success');
                return data;
            } else {
                local_links.showNotification(data.message, 'error');
                return null;
            }
        } catch (error) {
            console.error('Error adding to cart:', error);
            local_links.showNotification('Erreur lors de l\'ajout au panier', 'error');
            return null;
        }
    }
    ...
    static async updateItem(itemId, quantity) {
        try {
            ...
            local_links.showNotification('Erreur lors de la mise à jour du panier', 'error');
            return null;
        }
    }
    ...
    static async removeItem(itemId) {
        try {
            ...
            local_links.showNotification('Erreur lors de la suppression du panier', 'error');
            return null;
        }
    }
...
class FavoritesAPI {
    static async add(productId) {
        try {
            ...
            local_links.showNotification('Erreur lors de l\'ajout aux favoris', 'error');
            return null;
        }
    }
    ...
    static async remove(productId) {
        try {
            ...
            local_links.showNotification('Erreur lors de la suppression des favoris', 'error');
            return null;
        }
    }
}
...
class ReviewsAPI {
    static async add(productId, note, commentaire) {
        try {
            ...
            local_links.showNotification('Erreur lors de l\'ajout de l\'avis', 'error');
            return null;
        }
    }
}
...
class OrdersAPI {
    static async updateStatus(orderId, status) {
        try {
            ...
            local_links.showNotification('Erreur lors de la mise à jour du statut', 'error');
            return null;
        }
    }
}
...
class FormHandler {
    static async submitForm(formId, url, method = 'POST') {
        ...
        try {
            ...
            if (result.success) {
                local_links.showNotification(result.message || 'Opération réussie', 'success');
                return result;
            } else {
                const errorMessage = result.errors ? Object.values(result.errors).flat().join(', ') : result.message;
                local_links.showNotification(errorMessage || 'Erreur lors de l\'opération', 'error');
                return null;
            }
        } catch (error) {
            console.error('Error submitting form:', error);
            local_links.showNotification('Erreur lors de la soumission du formulaire', 'error');
            return null;
        } finally {
            local_links.hideLoading();
        }
    }
}
