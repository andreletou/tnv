...
urlpatterns = [
    ...
    path('portefeuille/', views.portefeuille_commercant, name='portefeuille_commercant'),
    path('portefeuille/retrait/', views.demande_retrait_commercant, name='demande_retrait_commercant'),
    path('api/portefeuille/statistiques/', views.api_statistiques_commercant, name='api_statistiques_commercant'),
